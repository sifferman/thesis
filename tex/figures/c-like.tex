...
\begin{figure}[t]
    ...
    \caption[
        ...
        Provided is an example of when C-like constructs can be used to write cleaner code compared to purely structural constructs.
        Sub-figures \ref{subfig:structural_only} and \ref{subfig:c-like_allowed} both implement the Find First Set operation, but \ref{subfig:c-like_allowed} is better.
    }
    \label{fig:c-like}
