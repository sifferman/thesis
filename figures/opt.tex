...
\begin{figure}[t]
    ...
    \subfloat[
        ...
        \includegraphics[width=0.9\linewidth]{media/opt/vivado.pdf}
    }

    \subfloat[
        Yosys without optimizations enabled infers the code as a series of 2:1 MUXes.
    ]{
        \includegraphics[width=0.7\linewidth]{media/opt/yosys_noopt.pdf}
    }

    \subfloat[
        Yosys with optimizations enabled infers the code as one parallel OR gate.
    ]{
        \includegraphics[width=0.7\linewidth]{media/opt/yosys_opt.pdf}
    }
